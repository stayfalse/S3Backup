...
namespace S3Backup
{
    public class AmazonFunctionsDryRunCheckerToAmazonFunctionsAdapter : IAmazonFunctions
    {
        private readonly IAmazonFunctionsDryRunChecker _adaptee;

        public AmazonFunctionsDryRunCheckerToAmazonFunctionsAdapter(IAmazonFunctionsDryRunChecker amazonFunctionsDryRunChecker)
        {
